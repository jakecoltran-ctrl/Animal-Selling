...
export const animals: Record<AnimalType, AnimalInfo> = {
  lion: {
    ...
    name: "Lion",
    title: "The Closer",
    icon: "/animals/lion.png",
    iconHead: "/animals/lion-head.png",
    color: "#dc2626",
    bgColor: "bg-lion-100",
  ...
  penguin: {
    ...
    name: "Penguin",
    title: "The Connector",
    icon: "/animals/penguin.png",
    iconHead: "/animals/penguin-head.png",
    color: "#0891b2",
  ...
  retriever: {
    ...
    icon: "/animals/retriever.png",
    iconHead: "/animals/retriever-head.png",
    color: "#d97706",
  ...
  beaver: {
    ...
    icon: "/animals/beaver.png",
    iconHead: "/animals/beaver-head.png",
    color: "#059669",
