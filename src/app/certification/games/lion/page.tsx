...
import { lionQuestions, gameMetadata, badges } from "@/lib/game-content";
...
type GameState = "intro" | "playing" | "review" | "results";
...
export default function LionGamePage() {
  ...
  const meta = gameMetadata.lion;
  const questions = lionQuestions;
  ...
  useEffect(() => {
    async function checkAuth() {
      ...
      if (!user) {
        router.push("/login?redirect=/certification/games/lion");
        return;
      }
      setUserId(user.id);
    }
  ...
  const finishGame = useCallback(async () => {
    ...
    const score = answers.filter((a) => a.isCorrect).length + (selectedOption ? (questions[currentQuestion].options.find((o) => o.id === selectedOption)?.isCorrect ? 1 : 0) : 0);
    ...
    return (
      <div className="py-12 relative overflow-hidden min-h-screen">
        <AnimatedBackground
          opacity={0.2}
          emojiOpacity={0.15}
          singleAnimal={{ type: "lion", color: meta.color }}
        />
      ...
      <div className="py-12 relative overflow-hidden min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto">
            ...
            <Card className="mb-6">
              <CardContent className="p-6">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <p className="text-lg">{question.scenario}</p>
                </div>
            ...
            {/* Feedback */}
            {showFeedback && (
              <Card className="mb-6 border-2" style={{ borderColor: selectedOptionData?.isCorrect ? "#22c55e" : "#ef4444" }}>
            ...
            <div className="flex justify-end gap-3">
              {!showFeedback ? (
                <Button
                  ...
                  style={{ backgroundColor: selectedOption ? meta.color : undefined }}
                >
                  Submit Answer
                </Button>
              ) : (
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              {results.passed
                ? "You've mastered the Lion's closing techniques!"
