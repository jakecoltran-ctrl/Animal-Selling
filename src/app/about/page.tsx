        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
            {animals.map((animal, index) => (
              ...
              >
                <div
                  className="relative overflow-hidden rounded-2xl p-8 h-full border-2 transition-all duration-300 hover:scale-[1.02]"
                  style={{
        ...
        <div className="container mx-auto px-4">
          ...
          <div className={`max-w-4xl mx-auto transition-all duration-1000 ${quadrantSection.inView ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            <div className="relative aspect-square max-w-2xl mx-auto">
              ...
              {/* Quadrants */}
              <div className="absolute top-[5%] left-[5%] w-[42%] h-[42%] rounded-2xl p-4 flex flex-col items-center justify-center text-center transition-transform hover:scale-105"
              ...
              <div className="absolute top-[5%] right-[5%] w-[42%] h-[42%] rounded-2xl p-4 flex flex-col items-center justify-center text-center transition-transform hover:scale-105"
              ...
              <div className="absolute bottom-[5%] left-[5%] w-[42%] h-[42%] rounded-2xl p-4 flex flex-col items-center justify-center text-center transition-transform hover:scale-105"
              ...
              <div className="absolute bottom-[5%] right-[5%] w-[42%] h-[42%] rounded-2xl p-4 flex flex-col items-center justify-center text-center transition-transform hover:scale-105"
