      ...
      <section ref={notAboutYouSection.ref} className="py-24 relative">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <Link
            ...
            className={`inline-block mb-6 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/30 hover:bg-amber-500/20 hover:border-amber-500/50 transition-all duration-700 ${notAboutYouSection.inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
          >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 border-2 border-amber-500/30 rounded-2xl p-8 text-center">
                ...
                <p className="text-gray-400 mb-4">Complete all 4 games with 80% accuracy to earn your certificate</p>
                <p className="text-xs text-amber-500/80 mb-6 flex items-center justify-center gap-1">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                  </svg>
                  Pro tip: The full report helps you ace the games
                </p>
